...
public class Book { //240531 15:00
	private String book_Code;					// 도서 코드
	...
	public Book(String book_Code, String book_Title, String book_Type, String book_Author, String book_Img,
			String book_Publisher, LocalDateTime book_Insert_Date, LocalDateTime book_Publish_Date,
			String book_ClaimingSymbol) {
	...
	public String toString() {
		return "Book [book_Code=" + book_Code + ", book_Title=" + book_Title + ", book_Type=" + book_Type
				+ ", book_Author=" + book_Author + ", book_Img=" + book_Img + ", book_Publisher=" + book_Publisher
				+ ", book_Insert_Date=" + book_Insert_Date + ", book_Publish_Date=" + book_Publish_Date
				+ ", book_ClaimingSymbol=" + book_ClaimingSymbol + ", book_Introduce=" + "]";
	}
}
